...
>(
  (
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-gradient-to-b from-purple-200 to-blue-200 p-0 text-brand-text [&>button]:hidden shadow-2xl"
            style={
              {
    ...
    return (
      <div
        ref={ref}
        className="group peer hidden md:block text-brand-text"
        data-state={state}
...
>(({ className, asChild = false, ...props }, ref) => {
  ...
  return (
    <Comp
      ...
      className={cn(
        "duration-200 flex h-8 shrink-0 items-center rounded-md px-2 text-sm font-bold text-brand-text-light outline-none ring-sidebar-ring transition-[margin,opa] ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0",
...
const sidebarMenuButtonVariants = cva(
  "peer/menu-button flex w-full items-center gap-3 overflow-hidden rounded-xl p-3 text-left text-lg font-bold outline-none ring-sidebar-ring transition-all duration-200 hover:bg-white/50 focus-visible:ring-2 active:bg-white/60 disabled:pointer-events-none disabled:opacity-50 group-has-[[data-sidebar=menu-action]]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-white data-[active=true]:text-blue-600 data-[active=true]:shadow-lg data-[state=open]:hover:bg-white/20 group-data-[collapsible=icon]:!size-12 group-data-[collapsible=icon]:!p-3 group-data-[collapsible=icon]:justify-center [&>span:last-child]:truncate [&>svg]:size-6 [&>svg]:shrink-0",
  {
    variants: {
      variant: {
